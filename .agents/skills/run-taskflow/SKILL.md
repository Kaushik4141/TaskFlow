...
bash .agents/skills/run-taskflow/boot_sidecar.sh
...
python .agents/skills/run-taskflow/drive_sidecar.py Config

# Drive /summarize with synthetic events, prints daily markdown + hub blocks:
python .agents/skills/run-taskflow/drive_sidecar.py Summarize --mode cloud_ai

# Drive /filter (relevance pipeline) with synthetic events:
python .agents/skills/run-taskflow/drive_sidecar.py Filter

# Health probe:
python .agents/skills/run-taskflow/drive_sidecar.py Health
```
